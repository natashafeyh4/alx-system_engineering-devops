...
* In addition to that, make sure that `task #3` of your [SSH project](https://github.com/abdelemjidessaid/alx-system_engineering-devops/tree/main/0x0B-ssh) is completed for web-01 and `web-02`. <b>You will likely need to add the public key to `web-02` as you only added it to `web-01` for this project</b>. The checker will connect to your servers to check MySQL status
